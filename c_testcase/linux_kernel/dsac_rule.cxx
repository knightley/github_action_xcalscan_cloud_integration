...
enum POC_ERR_CODE {
  __ERR_SLEEP_IN_ATOMIC_CONTEXT = 2019,
};
...
void spin_lock_irqsave(spinlock_t *lock, unsigned long flags)
{
  ...
  rbc.Rbc_assert(rbc.Do_not_call_sleep_in_atm(), // assertion predicate
                 __ERR_SLEEP_IN_ATOMIC_CONTEXT,
                 "SAC",
                 "Call may sleep function in atomic context.",
                 RBC_ENGINE::RULE_CATEGORY_USER,
                 "Replace with none sleep function.", 0); // assertion and error messages
  return;
}
